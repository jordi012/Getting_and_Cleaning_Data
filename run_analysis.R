...
# Please refer to greater details on how the scripts work and how they are   
# connected in the `README.md` and the `CodeBook.md` file in this repro) 
...
# 3.The unzipped files are in the folder UCI HAR Dataset. 
...
#  Details of the files that are used to load data are listed as follows
...
#  The Activity, Subject and Features will be used as part of descriptive variable names for data in data frame.
...
#  Factorize variable activity in the data frame data using descriptive
...
# [29] SITTING  SITTING (Value 5) 
# Their are 6 Levels - WALKING WALKING_UPSTAIRS WALKING_DOWNSTAIRS ... LAYING 

# Project step # 4: Appropriately label the data set with descriptive variable names
# Names of Features were labeled using descriptive variable names below

#     Data set -- replaced by -- Descriptive variable names
#  1. prefix t                        time
#  2. Acc                             Accelerometer
#  3. Gyro                            Gyroscope
#  4. prefix f                        frequency
#  5. Mag                             Magnitude
#  6. BodyBody                        Body
...
# Project step #5: Creates a second,independent tidy data set and outputs it.
# In this part,a second, independent tidy data set will be 
# created with the average of each variable for each activity and each subject based 
# on the data set in step 4.
...
{Data2<-aggregate(. ~subject + activity, Data, mean)
 ...
 write.table(head(Data2), file = "tidydata.txt",row.name=FALSE)
}